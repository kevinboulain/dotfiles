...
There is the built-in Ido, but it requires to be extended by multiple packages
(like Smex or =ido-vertical-mode=). Instead I rely on
[[https://github.com/raxod502/selectrum][Selectrum]] (as a replacement of
[[https://github.com/abo-abo/swiper][Ivy]]).

Use =C-j= to force an input not present in completions (similar to Ido's =C-f=),
or select what's in the prompt.
