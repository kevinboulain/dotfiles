...
(use-package lsp-mode
  ...
  (setq lsp-auto-guess-root t
        ...
        ;; don't load a bunch of packages I don't use
        ;; the downside being you'll need to require your preferred client
        ;; (which is a better default anyway) and invoke `lsp'
...
(use-package cmake-mode
  :straight (:host github
             ;; straight does not support shallow clones and the official
             ;; CMake repository is too big
             :repo "emacsmirror/cmake-mode"
             ;; this mirror doesn't have its files in the same location
